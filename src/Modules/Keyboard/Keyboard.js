...
const Keyboard = () => {
  ...
  useEffect(() => {
    ...
    const audioCS = new Audio(CSharp);
    const audioD = new Audio(D);
    const audioDS = new Audio(DSharp);
    const audioE = new Audio(E);
    const audioF = new Audio(F);
    const audioFS = new Audio(FSharp);
    const audioG = new Audio(G);
    const audioGS = new Audio(GSharp);
    const audioA = new Audio(A);
    const audioAS = new Audio(ASharp)
    ...
    sounds.s101 = audioAS;
    sounds.s66 = audioB;
  },[sounds.s67,sounds.s97,sounds.s68, sounds.s98, sounds.s69, sounds.s70, sounds.s99, sounds.s71, sounds.s100, sounds.s65, sounds.s101, sounds.s66])
