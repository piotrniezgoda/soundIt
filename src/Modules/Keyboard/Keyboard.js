...
const Keyboard = () => {
  ...
  const CSharpsound = () => {
    const audio = new Audio(CSharp)
    audio.play();
  }
  const DSharpsound = () => {
    const audio = new Audio(DSharp)
    audio.play();
  }
  const Esound = () => {
